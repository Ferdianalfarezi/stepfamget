        ...
        <table style="width:100%;border-collapse:collapse;">
            <thead>
                ...
                <tr style="background:#f8fafc;border-bottom:1px solid #e2e8f0;">
                    ...
                    <th rowspan="2" style="width:160px;padding:8px 12px;text-align:left;font-size:11px;font-weight:700;color:#94a3b8;border-right:1px solid #e2e8f0;vertical-align:middle;">ACTIVITY</th>
                    <th rowspan="2" style="width:170px;padding:8px 12px;text-align:left;font-size:11px;font-weight:700;color:#94a3b8;border-right:1px solid #e2e8f0;vertical-align:middle;">DETAIL</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f1f5f9;transition:background .15s;"
                    ...
                    <td style="padding:10px 8px;text-align:center;font-size:12px;color:#94a3b8;border-right:1px solid #f1f5f9;">{{ $i + 1 }}</td>
...
function submitAdd(e) {
    ...
    fetch('{{ route('gantt.store') }}', {
        ...
        body: new FormData(document.getElementById('formAdd')),
    })
