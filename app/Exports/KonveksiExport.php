...
class KonveksiExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    protected $request;
    protected $no = 0;
    ...
    {
        return ['No', 'NIK', 'Nama Karyawan', 'Departemen', 'Nama Anggota', 'Hubungan', 'Ukuran Baju', 'Jenis Kaos', 'Lengan Kaos'];
    }
